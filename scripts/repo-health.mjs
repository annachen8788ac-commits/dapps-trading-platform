...
check(!core.includes("$('.page').forEach"),'platform-core uses multi-element selector for page navigation');
check(!core.includes("$('[data-nav]').forEach"),'platform-core uses multi-element selector for navigation controls');
